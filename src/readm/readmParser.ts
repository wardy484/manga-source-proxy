...
export const parseMangaDetails = ($: CheerioAPI, mangaId: string): Manga => {
...
export const parseTags = ($: CheerioAPI): TagSection[] | null => {
    const arrayTags: Tag[] = []
...
export const parseUpdatedManga = ($: CheerioAPI, time: Date, ids: string[]): UpdatedManga => {
...
const getImageSrc = (imageObj: Cheerio<any> | undefined): string => {
    let image: any
...
const decodeHTMLEntity = (str: string): string => {
    ...
    // } catch (e) {
    //     console.log("Failed to decode html entity");
    //     return str;
    // }
